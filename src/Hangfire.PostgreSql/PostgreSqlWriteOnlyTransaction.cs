...
public class PostgreSqlWriteOnlyTransaction : JobStorageTransaction
{
  ...
  public override void RemoveHash(string key)
  {
    ...
    string query = _context.QueryProvider.GetQuery(static schemaName => $"DELETE FROM {schemaName}.hash WHERE key = @Key");
  ...
  public override void ExpireSet(string key, TimeSpan expireIn)
  {
    ...
    string query = _context.QueryProvider.GetQuery(static schemaName => $"UPDATE {schemaName}.set SET expireat = @ExpireAt WHERE key = @Key");
  ...
  public override void ExpireList(string key, TimeSpan expireIn)
  {
    ...
    string query = _context.QueryProvider.GetQuery(static schemaName => $"UPDATE {schemaName}.list SET expireat = @ExpireAt WHERE key = @Key");
  ...
  public override void ExpireHash(string key, TimeSpan expireIn)
  {
    ...
    string query = _context.QueryProvider.GetQuery(static schemaName => $"UPDATE {schemaName}.hash SET expireat = @ExpireAt WHERE key = @Key");
  ...
  public override void PersistSet(string key)
  {
    ...
    string query = _context.QueryProvider.GetQuery(static schemaName => $"UPDATE {schemaName}.set SET expireat = null WHERE key = @Key");
  ...
  public override void PersistList(string key)
  {
    ...
    string query = _context.QueryProvider.GetQuery(static schemaName => $"UPDATE {schemaName}.list SET expireat = null WHERE key = @Key");
  ...
  public override void PersistHash(string key)
  {
    ...
    string query = _context.QueryProvider.GetQuery(static schemaName => $"UPDATE {schemaName}.hash SET expireat = null WHERE key = @Key");
  ...
  public override void AddRangeToSet(string key, IList<string> items)
  {
    ...
    string query = _context.QueryProvider.GetQuery(static schemaName => $"INSERT INTO {schemaName}.set (key, value, score) VALUES (@Key, @Value, 0.0)");
  ...
  public override void RemoveSet(string key)
  {
    ...
    string query = _context.QueryProvider.GetQuery(static schemaName => $"DELETE FROM {schemaName}.set WHERE key = @Key");
