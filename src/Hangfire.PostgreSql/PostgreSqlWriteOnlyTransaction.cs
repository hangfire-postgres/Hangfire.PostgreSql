...
";
        ...
        private const string CounterQuery = @"INSERT INTO ""{0}"".""counter""(""key"", ""value"") VALUES (@key, @value);";

        public override void IncrementCounter(string key, TimeSpan expireIn) => IncrementCounter(key);

        public override void IncrementCounter(string key)
        {
            var sql = string.Format(CounterQuery, _options.SchemaName);
            QueueCommand((con, trx) => con.Execute(sql, new { key, value = +1 }, trx));
        }

        public override void DecrementCounter(string key, TimeSpan expireIn) => DecrementCounter(key);
...
";
        ...
        public override void ExpireSet(string key, TimeSpan expireIn)
        {
            ...
            var query = $@"UPDATE ""{_options.SchemaName}"".""set"" SET ""expireat"" = @expireAt WHERE ""key"" = @key";
        ...
        public override void ExpireList(string key, TimeSpan expireIn)
        {
            ...
            var query = $@"UPDATE ""{_options.SchemaName}"".""list"" SET ""expireat"" = @expireAt WHERE ""key"" = @key";
        ...
        public override void ExpireHash(string key, TimeSpan expireIn)
        {
            ...
            var query = $@"UPDATE ""{_options.SchemaName}"".""hash"" SET expireat = @expireAt WHERE ""key"" = @key";
        ...
        public override void PersistSet(string key)
        {
            ...
            var query = $@"UPDATE ""{_options.SchemaName}"".""set"" SET expireat = null WHERE ""key"" = @key";
        ...
        public override void PersistList(string key)
        {
            ...
            var query = $@"UPDATE ""{_options.SchemaName}"".""list"" SET expireat = null WHERE ""key"" = @key";
        ...
        public override void PersistHash(string key)
        {
            ...
            var query = $@"UPDATE ""{_options.SchemaName}"".""hash"" SET expireat = null WHERE ""key"" = @key";
        ...
        public override void AddRangeToSet(string key, IList<string> items)
        {
            ...
            var query = $@"INSERT INTO ""{_options.SchemaName}"".""set"" (""key"", ""value"", ""score"") VALUES (@key, @value, 0.0)";
        ...
        public override void RemoveSet(string key)
        {
            ...
            var query = $@"DELETE FROM ""{_options.SchemaName}"".""set"" WHERE ""key"" = @key";
