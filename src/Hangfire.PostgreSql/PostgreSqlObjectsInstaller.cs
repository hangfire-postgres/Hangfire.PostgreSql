...
public static class PostgreSqlObjectsInstaller
{
  ...
  internal static void Install(PostgreSqlStorageContext context)
  {
    if (context == null)
    {
    ...
    PostgreSqlDbConnectionManager connectionManager = context.ConnectionManager;
    NpgsqlConnection connection = connectionManager.CreateAndOpenConnection();
    try
    {
